...
func NewUsageCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			fmt.Printf("TASK %s\n", id)
			fmt.Println("ID  ROLE      PROVIDER  MODEL  INPUT  CACHED  OUTPUT  REASONING  TURNS  STATUS")
